...
<head>
	...
	<meta name="author" content="周年快乐">
	<meta name="description" content="周年快乐">
	<title>周年快乐</title>
	...
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				<p class="text1"><span id="text-75" contenteditable="true">斌宝</span> ❤ <span id="text-76" contenteditable="true">钰宝</span> <span id="text-77" contenteditable="true">执子之手，与子偕老</span></p>
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="true">开始倾听我们的故事</span></p>
			</div>
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				<p class="top-text" id="text-1" contenteditable="true">过去的斌宝一直是一个人生活，享受着孤独，也憧憬着爱情。</p>
				<img src='img/iali63.jpg'  alt="过去的斌宝一直是一个人生活，享受着孤独，也憧憬着爱情。" />
			</div>
			...
			<div id="/section-1/page-4" class="ft-page page-4 full-img" data-id="page-4">
				<h2 class="center-text" id="text-3" contenteditable="true">一个人的发呆..</h2>
		...
		<div class="ft-section section-2" data-id="section-2">
			<div id="/section-2/page-1" class="ft-page page-5 full-img" data-id="page-1">
				<h2 class="center-text" id="text-4" contenteditable="true">一个人的公交..</h2>
				<img src='img/iali19.jpg'  alt="一个人的山岗" />
			</div>
			<div id="/section-2/page-2" class="ft-page page-6" data-id="page-2">
				<h2 class="center-text" id="text-5" contenteditable="true">一个人的做梦</h2>
		...
		<div class="ft-section section-3" data-id="section-3">
			...
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				<img src='img/iali64.jpg' alt='可是斌宝的爱情又在哪里呢？' />
				<h3 id="text-13" contenteditable="true">可是斌宝的爱情又在哪里呢？</h3>
			</div>
			...
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				<h3><span id="text-17" contenteditable="true">于是，斌宝一个人继续向前走</span><br /><span id="text-18" contenteditable="true">走在茫茫的雪地上</span></h3>
				<img src='img/iali66.jpg' />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="true">直到有一天斌宝与钰宝相遇了</h3>
		...
		<div class="ft-section section-4" data-id="section-4">
			...
			<div id="/section-4/page-7" class="ft-page page-24 full-img" data-id="page-7">	
				<h3 id="text-26" contenteditable="true">晚上斌宝会把钰宝送回宿舍</h3>
		...
		<div class="ft-section section-5" data-id="section-5">
			...
			<div id="/section-5/page-7" class="ft-page page-31" data-id="page-7">
				<h3 id="text-34" contenteditable="true">于是斌宝开始学习新的技能</h3>
		...
		<div class="ft-section section-7" data-id="section-7">
			...
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				...
				<h3 id="text-46" contenteditable="true"> 斌宝又怎会飞的更高更远</h3>
			</div>
			<div id="/section-7/page-4" class="ft-page page-42" data-id="page-4">
				<h3><span id="text-47" contenteditable="true">斌宝不想这样，他要为钰宝改变自己</span><br /><span id="text-48" contenteditable="true">在钰宝支持下，他向更大平台投递了简历</span></h3>
				<img src='img/iali69.jpg'  />
			</div>
			<div id="/section-7/page-5" class="ft-page page-43" data-id="page-5">
				<img src='img/iali42.jpg' />
				<h3 id="text-49" contenteditable="true">斌宝如愿进入了更大的公司，并且竭尽所能和钰宝在一个城市工作</h3>
			</div>
			<div id="/section-7/page-6" class="ft-page page-44 left-img" data-id="page-6">
				<h3><span id="text-50" contenteditable="true">斌宝和钰宝终于又能每天腻在一起了</span><br /><span id="text-51" contenteditable="true">他们的生活越来越好，两个人也都为对方变得更加优秀</span></h3>
				<img src='img/iali0.jpg' />
			</div>
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				<h3><span id="text-52" contenteditable="true">再到后来，他们拥有了属于自己的房子</span><br /><span id="text-53" contenteditable="true">他们一起设计未来爱的小窝</span></h3>
		...
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				...
				<h3>
					<span id="text-54" contenteditable="true">他们搬进了新房子</span>
					<span id="text-55" contenteditable="true">斌宝好开心</span>
					<span id="text-56" contenteditable="true">因为和钰宝在爱的小窝的每一天</span>
					<span id="text-57" contenteditable="true">仿佛都是在过情人节</span>
				</h3>
			</div>
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				<img src='img/iali58.jpg' />
				<h3>
					<span id="text-58" contenteditable="true">终于</span>
					<span id="text-59" contenteditable="true">斌宝和钰宝走进了婚姻的殿堂</span>
					<span id="text-60" contenteditable="true">斌宝真的好开心</span>
					<span id="text-61" contenteditable="true">因为这一天，斌宝拥有了全世界</span></h3>
				
			</div>
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				<p><span id="text-62" contenteditable="true">婚礼上，他们郑重宣誓</span><br /><span id="text-63" contenteditable="true">无论富贵还是更富贵、无论健康还是更健康、他们永远都要在一起</span></p>
				<img src='img/iali65.jpg'  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
			<img src='img/iali71.jpg' />
				<p class="text">
					<span class='text' id="text-64" contenteditable="true">斌宝很幸福，因为他找到了钰宝。他相信后面的每天都会是快乐的</span><br />
					<span class='text' id="text-65" contenteditable="true">简简单单，体会着与钰宝在一起的每一个刻</span>
				</p>
			</div>
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				<p class='text' id="text-66" contenteditable="true">他们一起产检，每项检查都顺利通过，他们夜里会聆听来自小兔崽子的强劲心跳，也会摸摸肚肚拍拍孕妇照</p>
			...
			<div id="/section-8/page-6" class="ft-page page-51" data-id="page-6">
				<p>
					<span id="text-67" contenteditable="true">钰宝：永远有多远？</span><br />
					<span id="text-68" contenteditable="true">斌宝：比时间多一秒就是永远，我会永远爱你</span><br />
					<span id="text-69" contenteditable="true">钰宝：世界有多大？</span><br />
					<span id="text-70" contenteditable="true">斌宝：你走到哪里，世界就有多大</span>
					</p>
			</div>
		</div>
		<div class="ft-section section-9" data-id="section-9">
			...
			<div id="/section-9/page-2" class="ft-page page-53" data-id="page-2">
				...
				<h3 id="text-72" contenteditable="true">老婆，周年快乐</h3>
			</div>
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				...
				<p class="text">
					<span id="text-73" contenteditable="true">斌宝和钰宝的故事会一直继续下去。</span><br />
